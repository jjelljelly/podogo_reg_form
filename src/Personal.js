    ...
    <div>
      <div className="reg-border">
        ...
        <form className="reg-form" onSubmit={(e) => onClick(e)}>
          <label>
            Title: <br />
            <select value={fields.title} onChange={(e) => updateFields('title', e.target.value)} required>
          ...
          <TextInput
            ...
            setValue={(name, value) => updateFields(name, value.length > 0 ? value[0].toUpperCase() + value.slice(1).toLowerCase() : value)}
          ...
          <label>
            ...
            <select name="insurer" value={fields.insurer} onChange={(e) => updateFields('insurer', e.target.value)} required>
              <option value="" defaultValue>-Select a method of payment-</option>
          ...
          {fields.insurer && fields.insurer !== "" && fields.insurer !== 'Self-funding' ?
            <>
              <hr />
              <TextInput
                name="membership_number"
                value={fields.membership_number}
                setValue={(name, value) => updateFields(name, value)}
                required
              />
              ...
              <TextInput
                ...
                value={fields.authorisation_number}
                setValue={(name, value) => updateFields(name, value)}
                required
              />
              <hr />
